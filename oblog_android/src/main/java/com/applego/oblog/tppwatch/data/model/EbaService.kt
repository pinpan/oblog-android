...
enum class EbaService (val code: String, val psd2Code: String, val shortDescription: String, val description: String, val order: Int) {
    ...
    ALL_PSD2("ALL_PSD2", "PSD2",  "All PSD2 services", "An aggregation item for all PSD2 services: AIS, PIS, CII", 2),
    ...
    PS_05A("PS_05A", "PIIS", "Payment instruments issuing", "5. Issuing of payment instruments.", 11),
    ...
    PS_070("PS_070", "PIS", "Payment initiation", "7. Payment initiation services.", 14),
    PS_080("PS_080", "AIS", "Account information", "8. Account information services.", 15),
    ...
    companion object {
        ...
        val allPsd2Servies = arrayListOf<EbaService>()
        ...
        init {
            ...
            allPsd2Servies.add(PS_080)
            allPsd2Servies.add(PS_070)
            allPsd2Servies.add(PS_05A)
            allPsd2Servies.forEach {
                allPsd2ServiceMap.put(it.name, it)
            }

            psd2ServiesWithAllOption.add(ALL_PSD2)
            psd2ServiesWithAllOption.addAll(allPsd2Servies)
