...
class EbaEntitiesListDeserializer : JsonDeserializer<List<Tpp>> {

    companion object {
        private var INSTANCE: EbaEntitiesListDeserializer? = null
        val tppListDeserializer: EbaEntitiesListDeserializer
            get() {
                if (INSTANCE == null) {
                    INSTANCE = EbaEntitiesListDeserializer()
                }
                return INSTANCE!!
            }
    }
